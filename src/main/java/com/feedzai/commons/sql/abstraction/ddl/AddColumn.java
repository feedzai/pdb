...
/**
 * Expression to translate {@code ALTER TABLE... ADD COLUMN...} statements.
 *
 * @author Joao Silva (joao.silva@feedzai.com)
 * @since 2.1.5
 */
public class AddColumn extends Expression {
    ...
    /**
     * Creates a new instance of {@link AddColumn}.
     *
     * @param table  The table where the column resides.
     * @param column The column definition.
     */
    public AddColumn(Expression table, DbColumn column) {
        this.table = table;
        this.column = column;
    }
