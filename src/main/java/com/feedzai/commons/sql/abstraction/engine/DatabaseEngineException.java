...
/**
 * Represents {@link AbstractDatabaseEngine} exceptions.
 *
...
public class DatabaseEngineException extends Exception {
     ...
     *              unknown.)
     */
    public DatabaseEngineException(Throwable cause) {
        super(cause);
    }
     ...
     *                           be writable
     */
    protected DatabaseEngineException(String message, Throwable cause,
