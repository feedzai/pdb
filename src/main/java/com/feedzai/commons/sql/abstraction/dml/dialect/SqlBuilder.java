...
public final class SqlBuilder {
    ...
    /**
     * A {@link #L list} of {@link K constants}.
     *
     ...
     */
    public static Expression LofK(final Object... constants) {
        return LofK(Arrays.stream(constants));
    }
     ...
     * A {@link #L list} of {@link K constants}.
     *
     * @param constantsStream A {@link Stream} constant objects to generate the {@link K SQL constants} to include
     *                       in the list.
     * @return The {@link #L list} expression.
     */
    public static Expression LofK(final Stream<?> constantsStream) {
        return L(constantsStream.map(SqlBuilder::k).collect(Collectors.toCollection(LinkedList::new)));
    }
